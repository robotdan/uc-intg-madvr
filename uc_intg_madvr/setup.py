...
class MadVRSetup:
    ...
    async def handle_setup(self, msg: SetupDriver) -> SetupAction:
        ...
        if isinstance(msg, DriverSetupRequest):
            ...
            # Values come from saved config (persisted to disk before connection test)
            ...
            return RequestUserInput(
                ...
                settings=[
                    ...
                    },
                    {
                        ...
                        "field": {"number": {"value": polling_interval, "min": const.MIN_POLL_INTERVAL}}
                    }
                ]
            )
    ...
    async def _handle_user_input(self, input_values: dict[str, str]) -> SetupAction:
        ...
        # Save user input immediately so values survive process restarts on retry
